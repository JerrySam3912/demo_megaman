...
public abstract class Human extends ParticularObject {
    ...
    public void Update(){
        ...
        Rectangle reactTop = getGameWorld().physicalMap.haveCollisionWithTop(boundForCollisionWithMapFuture);
        if(reactTop!= null){
            setSpeedY(0);
            setPosY(reactTop.y+ getGameWorld().physicalMap.getTileSize()+ getHeight()/2);
