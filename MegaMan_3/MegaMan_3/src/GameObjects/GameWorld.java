...
import GameObjects.BackgroundMap;
...
import GameObjects.RedEyeDevil;
...
public class GameWorld {
    ...
    public GameWorld(){
        ...
        backgroundMap = new BackgroundMap(this, 0, 0);
        camera = new Camera(GameFrame.SCREEN_HEIGHT, GameFrame.SCREEN_WIDTH, this, 0, 50);
